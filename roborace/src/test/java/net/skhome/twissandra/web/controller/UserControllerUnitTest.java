...
public class UserControllerUnitTest {
	...
	@DataPoint
	public static UserAccount ACCOUNT_TO_BE_CREATED = new UserAccount(null, "username", "password");
	
	@DataPoint
	public static UserAccount ACCOUNT_TO_BE_UPDATED = new UserAccount(UUID.randomUUID().toString(), "username", "password");
